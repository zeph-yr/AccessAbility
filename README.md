...
Supports Left and Right Hand playersettings, Multiplayer, OST / DLC, Practice Mode, Custom and Base Campaigns.
...
- Adjust the `Disappearing Distance` slider for how close you want the blocks to come before they disappear. 6.0 keeps them out of saber-reach. 3.0 and below automatically turns off score submission.
...
- Set `Disappearing Distance` to 0. This means the disappearing color blocks *will* reach you, so try not to hit the wrong color!
